 ...
 * A distinctive amber/gold badge to indicate recommended templates for campaigns
 */
export function RecommendedBadge({
    ...
    return (
        <CardBadge
            variant="border"
            className={cn(
                "gap-1 bg-amber-400/15 text-amber-600 ring-amber-400/30 dark:bg-amber-400/10 dark:text-amber-400 dark:ring-amber-400/20",
                props.className
            )}
            {...props}
        >

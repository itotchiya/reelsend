                ...
                {sortedRoles.map((role) =>
                    isSuperAdmin(role) ? (
                        ...
                        >
                            ...
                            <CardContent className="pt-6">
                                <div className="flex flex-col items-center text-center">
                                    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-amber-500/20 to-yellow-500/20 border border-amber-500/30 mb-4">
                                        <ShieldCheck className="h-8 w-8 text-amber-500" />
                                    </div>

                                    <h3 className="text-xl font-bold mb-1">{role.name}</h3>

                                    <span className="text-sm text-amber-500 font-medium mb-3">
                                        Full Access
                                    </span>
                        ...
                        <InteractiveCard key={role.id} onClick={() => handleEditRole(role)}>
                            <div className="flex flex-col items-center text-center">
                                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 mb-4">
                                ...
                                {role.isSystem && (
                                    <span className="text-sm text-indigo-400 font-medium mb-3">
                                        System Role
                                    </span>
                                )}

...
export function AudienceClient({ audience: initialAudience }: AudienceClientProps) {
    ...
    useEffect(() => {
        ...
        // We'd ideally want a way to add the audience level breadcrumb too if the system supports nested overrides
    ...
    const handleDeleteContact = async (contactId: string) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                fetchContacts();
                // Optionally update audience count locally
    ...
    return (
        <>
            ...
            <PageContent>
                <div className="space-y-6">
                    ...
                    <div className="grid gap-4 sm:grid-cols-3">
                        ...
                        {/* More stats cards could go here (Source, Activity, etc.) */}
                    </div>
            ...
            <ImportContactsDialog
                ...
                onSuccess={() => {
                    fetchContacts();
                    // We'll need to fetch the audience again or update count properly after bulk import
                    router.refresh();
                }}
            />
        </>

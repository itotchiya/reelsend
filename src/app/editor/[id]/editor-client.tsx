...
export function EmailEditorClient({ template, savedBlocks: initialSavedBlocks }: EmailEditorClientProps) {
    ...
    return (
        <div className="h-screen flex flex-col bg-background">
            {/* Header */}
            <header className="h-20 border-b flex items-center justify-between px-8 bg-background sticky top-0 z-50">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 ml-4">
                        <div className={cn(
                            ...
                            hasChanges ? "bg-red-500" : "bg-green-500"
                        )} />
                        <span className={cn(
                            "text-xs font-medium",
                            hasChanges ? "text-red-500" : "text-green-500"
                        )}>
